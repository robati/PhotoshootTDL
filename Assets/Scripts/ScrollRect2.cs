...
namespace UnityEngine.UI
{
    ...
    /// </remarks>// IBeginDragHandler, IEndDragHandler, IDragHandler,
    public class ScrollRect2 : UIBehaviour, IInitializePotentialDragHandler, IScrollHandler, ICanvasElement, ILayoutElement, ILayoutGroup
    {
        /// <summary>
